...
- просмотр задания Лабораторной работы №3:
  - cформировать цели команды и планирование работы
  - кол-во рабочих дней (заданы пользователем) между двумя датами. Результат работы программы должен быть сохранен в программе.
