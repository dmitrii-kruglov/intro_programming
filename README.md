...
- просмотр задания Лабораторной работы №3:
   - сформировать цели команды и планирование работы
   - задача: дублировать числа-палиндромы в наборе чисел. Необходимо сохранить результат в программе, а не просто вывести результат.
...
- вывести в порядке возрастания и убывания
