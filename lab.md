...
## Задача 5
Программа должна нарисовать домик, используя символы. Вводятся кол-во этажей и ширина дома. Высота этажа изменяется пропорционально ширине, так чтобы этаж выглядел квадратным. На каждом этаже по центру должно быть одно окно. А на первом этаже справа находится дверь. Размеры двери - ширина одна треть от ширины дома, высота должны выглядеть в два раза больше.
